...
import com.env.dao.intf.IPtCompanyDao;
 ...
 * @since 1.0
 */
@Service("ptCompanyService")
public class PtCompanyService<T extends PtCompany> extends DefaultServiceImpl<T> implements IPtCompanyService<T> {
	/**
	 * 自动注入的数据访问对象
	 */
	@Autowired
