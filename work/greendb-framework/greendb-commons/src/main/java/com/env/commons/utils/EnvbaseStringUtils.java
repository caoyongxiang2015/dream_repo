...
public class EnvbaseStringUtils {
    ...
    public static String parseDateString(String time) {
        ...
        try {
            ...
            if (Integer.parseInt(month) < 10) {
                month = EnvbaseStringUtils.addZero(month, 2);
            }

            String day = temp.substring(temp.indexOf("-") + 1);
            if (Integer.parseInt(day) < 10) {
                day = EnvbaseStringUtils.addZero(day, 2);
            }
    ...
    public static String DealSpecialChar(String specialString) {
        if (isNotEmpty(specialString)) {
            ...
            Map<Object, Object> specialChars = ArrayUtils
    ...
    /**
     * 给url添加指定的字符串，比如appendPiex("http://www.envbase.com/abc.jsp","abc")
     * 返回http://www.envbase.com/abcabc.jsp
     * 
     * @param url
     * @param piex
     * @return
    ...
    /**
     * 为一个图片url添加前缀
     * 如:http://style.envbase.com/img_uploaded/admin/upload/fp/pic/2012
     * /2012525/JwV2DZnBjJANXjuzHLTEMcWpa.jpg 添加后的地址为:
     * http://style.envbase.com/img_uploaded
    ...
    public final static TypeConverter<String, Integer> STR_2_INT_ARR_CONVETER = new TypeConverter<String, Integer>() {
        public Integer convert(String s) {
            if (EnvbaseStringUtils.isEmpty(s)) {
                return null;
            } else {
    ...
    public static <T> List<T> convertString2Array(String source,
        ...
        if (EnvbaseStringUtils.isEmpty(source)) {
