...
public class RegExpValidatorUtils {
	...
	*/
	...
	public static boolean isUserName(String str) {
		...
		return match(regex, str) && str.length() >=1 && str.length()<=25 ;
	}
	 ...
	 * @param 待验证的字符串
	 * @return 如果是符合的字符串,返回 <b>true </b>,否则为 <b>false </b>
	 * 13[0-9]{9}|15[012356789][0-9]{8}|18[0256789][0-9]{8}|147[0-9]{8}|147[0-9]{8}
	 */
	public static boolean isPhone(String str) {
		String regex = "^13[0-9]{9}|15[0-9][0-9]{8}|18[0-9][0-9]{8}|147[0-9]{8}|177[0-9]{8}$";
	 ...
	 * @return 如果是符合的字符串,返回 <b>true </b>,否则为 <b>false </b>
	 */
	public static boolean isImgCode(String str) {
