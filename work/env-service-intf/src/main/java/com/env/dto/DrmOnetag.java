/**
 * Description: DrmOnetag数据库实体/领域对象
 ...
 * @since 1.0
 */
public class DrmOnetag extends DomainObject{
	/**
	 * 
	 */
...
//	private java.lang.Integer id;
	 ...
	 */
	//
	private java.lang.Integer onetaglibid;
    ...
    */
	...
	/**
	 * 设置一级标签库id
	 * @param onetaglibid 一级标签库id
	 */
	public void setOnetaglibid(java.lang.Integer onetaglibid) {
		this.onetaglibid = onetaglibid;
	}
	 ...
	 * @return 一级标签库id
	 */
	public java.lang.Integer getOnetaglibid() {
		return this.onetaglibid;
	}

	/**
	 * 设置一级标签名称
	 * @param tagname 一级标签名称
	 */
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
			...
			.append("Onetaglibid",getOnetaglibid())
	...
	public boolean equals(Object obj) {
		if(obj instanceof DrmOnetag == false) return false;
		if(this == obj) return true;
//		DrmOnetagEntity other = (DrmOnetagEntity)obj;
		DrmOnetag other = (DrmOnetag)obj;
