...
<title>修改PtCompany</title>
</head>
<body>
    <a href="/">首页</a>
	<form action="${ctx }/ptcompany/update" method="POST">
		<table>
<tr>
	<td>id:</td>
	<td>
...
<tr>
	...
	<input type="text" id="entity.companyName"
		...
		<font color="red">
			<form:errors path="entity.companyName" />
		</font>
	</td>
</tr>
<tr>
	...
	<input type="text" id="entity.version"
		...
		<font color="red">
			<form:errors path="entity.version" />
		</font>
	</td>
</tr>
<tr>
	...
	<input type="text" id="entity.disabled"
		...
		<font color="red">
			<form:errors path="entity.disabled" />
		</font>
	</td>
</tr>
<tr>
	...
	<input type="text" id="entity.createUserid"
		...
		<font color="red">
			<form:errors path="entity.createUserid" />
		</font>
	</td>
</tr>
<tr>
	...
	<input type="text" id="entity.createTimeStr"
		...
		<font color="red">
			<form:errors path="entity.createTime" />
		</font>
	</td>
</tr>
<tr>
	...
	<input type="text" id="entity.updateUserid"
		...
		<font color="red">
			<form:errors path="entity.updateUserid" />
		</font>
	</td>
</tr>
<tr>
	...
	<input type="text" id="entity.updateTimeStr"
		...
		<font color="red">
			<form:errors path="entity.updateTime" />
		</font>
	</td>
</tr>
			<tr>
