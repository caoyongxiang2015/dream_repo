						...
						<div class="row-fluid">
							...
							<div class="span6 control-group">
								...
								<div class="controls">
									<c:choose>
										<c:when test="${action=='create' || action=='edit'}">
											<envbase:sexRadioTag required="true" name="entity.sex"
												value="${entity.sex}" />
											<font color="red"><form:errors
						...
						<div class="row-fluid">
							...
							<div class="span6 control-group">
								...
								<div class="controls">
									<c:choose>
										<c:when test="${action=='create' || action=='edit'}">
											<envbase:sexSelectTag style="width: 220px;" required="true"
						...
						<div class="row-fluid">
							<div class="span6 control-group">
								...
								<div class="controls">
									<c:choose>
										<c:when test="${action=='create' || action=='edit'}">
											<envbase:testProvinceSelectTag style="width: 220px;"
							...
							<div class="span6 control-group">
								...
								<div class="controls">
									<c:choose>
										<c:when test="${action=='create' || action=='edit'}">
											<envbase:testCitySelectTag testProvinceId=""
