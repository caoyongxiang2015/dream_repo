...
<html>
<head>
<title>envbase list sample</title>
<script type="text/javascript">
	$(document).ready(function() {
		$("#deleteObj").click(function() {
			EnvbaseUtil.createModal("删除#One-Object#", //标题
			...
			<div>
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td>权限代码样例</td>
							<td><a href="${ctx}/sample/rightSample">${ctx}/sample/rightSample</a></td>
							<td>shiro 标签示例</td>
							<td>env base</td>
						</tr>
						<tr>
						...
						<tr>
							<td>列表样例2</td>
							<td><a href="${ctx}/sample/index">${ctx}/sample/index</a></td>
